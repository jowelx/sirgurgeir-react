    ...
    <Grid container justifyContent={"center"} >
      <Grid item xs={11}>
        <Grid container columnSpacing={0}>
          <Grid item xs={6} style={{height:'100vh',display:'flex',flexDirection:'column',justifyContent:"space-between"}}>
                    { menu===0? <Delivery setManu={setManu} />:<Payment/>}
                          ...
                          <MenuItem>
                              Payment
                              <Bar style={{backgroundColor:menu ===1?BLUECOLOR:'rgb(232,232,232)'}} />
                          </MenuItem>
                      </MenuContainer>
                  </Grid>
                  <Grid item xs={6}>
